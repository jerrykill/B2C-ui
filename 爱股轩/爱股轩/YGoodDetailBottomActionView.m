...
-(YSPTButton *)collectBtn{
    if (!_collectBtn) {
        ...
        [_collectBtn setImage:MImage(@"collect_off") forState:BtnNormal];
        [_collectBtn setImage:MImage(@"collect_on") forState:BtnStateSelected];
...
-(UIButton *)payBtn{
    if (!_payBtn) {
        ...
        _payBtn.backgroundColor = LH_RGBCOLOR(207, 29, 27);
