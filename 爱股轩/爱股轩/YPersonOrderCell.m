...
-(void)initView{
    ...
    _logoIV = [[UIImageView alloc]initWithFrame:CGRectMake((__kWidth/5-AutoWidth(20))/2, AutoWidth(15), AutoWidth(20), AutoWidth(20))];
    [self addSubview:_logoIV];

    _titleLb = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectYH(_logoIV)+AutoWidth(10), __kWidth/5, AutoWidth(15))];
